            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-tools">
                        <template v-if="listaRolPermisosByUsuario.includes('producto.crear')">
                        ...
                        <table class="table table-hover table-head-fixed text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in listarProductosPaginated" :key="index">
                                    ...
                                    <td>
                                        <template v-if="listaRolPermisosByUsuario.includes('producto.editar')">
    ...
    export default {
        ...
        methods: {
            limpiarCriteriosBsq(){
                ...
                this.fillBsqProducto.cDescription = '';
                this.fillBsqProducto.nIdCategoria = '';
            },
